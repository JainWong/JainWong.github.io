...
```yml
# Site settings
title: JainWong Blog             # title of your website
SEOTitle: JainWong Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: JainWong     # modify this account to yours
weibo_username: JainWong      # the footer woule be auto-updated.
...
For instance, [Hello 2015])(https://jainwong.github.io/2015/01/29/hello-2015/) has the front-matter of this:
...
1. a _text style_ header like [this](https://jainwong.github.io/2019/09/08/spacemacs-workflow/) with
...
sidebar-avatar: /img/avatar-JainWong.jpg     # use absolute URL.
```
...
![](https://jainwong.github.io/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "https://jainwong.github.io/js-module-7day/"
---
```
...
It's possible that you want the two things different. For me, my site-title is **“JainWong Blog”** but I want the title shows in search engine is **“JainWong的博客 | JainWong Blog”** which is multi-language.
...
- Fixed [issue#15](https://github.com/JainWong/JainWong.github.io/issues/15) about code wrap.
...
<img src="https://jainwong.github.io/img/blog-md-navbar.gif" width="320" />
